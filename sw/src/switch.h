...
#define GPIO_PORTE_DATA_PIN0 ((volatile uint32_t *)0x40024004) // bit band for PORTE pin0
#define GPIO_PORTE_DATA_PIN1 ((volatile uint32_t *)0x40024008) // bit band for PORTE pin1
#define GPIO_PORTE_DATA_PIN2 ((volatile uint32_t *)0x40024010) // bit band for PORTE pin2
#define GPIO_PORTE_DATA_PIN3 ((volatile uint32_t *)0x40024020) // bit band for PORTE pin3
#define GPIO_PORTE_DATA_PIN4 ((volatile uint32_t *)0x40024040) // bit band for PORTE pin4
